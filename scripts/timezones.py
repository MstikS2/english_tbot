...
def get_timezone_by_city(city, nominatim_user_agent):
    ...
    return (loc, timezone(tzfinder.timezone_at(lng=loc.longitude,
                                               lat=loc.latitude)))
